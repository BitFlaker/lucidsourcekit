...
public class RecordingObjectTools {
    private static RecordingObjectTools instance;
    private Context context;

    private RecordingObjectTools(Context context) { this.context = context; }

    public static RecordingObjectTools getInstance(Context context){
        if(instance == null) {
            instance = new RecordingObjectTools(context);
        }
        return instance;
    }
