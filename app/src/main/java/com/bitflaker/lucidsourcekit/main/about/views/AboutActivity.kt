package com.bitflaker.lucidsourcekit.main.about.views
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.crdIssues.setOnClickListener {
            startActivity(
                Intent(
                    Intent.ACTION_VIEW,
                    "https://github.com/BitFlaker/lucidsourcekit/issues".toUri()
                )
            )
        }
        binding.crdSourceCode.setOnClickListener {
            startActivity(
                Intent(
                    Intent.ACTION_VIEW,
                    "https://github.com/BitFlaker/lucidsourcekit".toUri()
                )
            )
        }
