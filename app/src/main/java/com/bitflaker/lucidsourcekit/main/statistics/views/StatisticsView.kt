...
import com.bitflaker.lucidsourcekit.utils.AppUsage
...
class StatisticsView : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnDreamFrequencyFilter.setOnClickListener {
            ...
            val popup = PopupMenu(
                ContextThemeWrapper(context, R.style.Theme_LucidSourceKit_PopupMenu_Icon),
                binding.btnDreamFrequencyFilter
            )
    ...
    private fun setAppSessionStats(appOpenTimes: List<AppUsage.AppOpenStats>) {
    ...
    private suspend fun generateDreamJournalStats(timeSpan: Pair<Long, Long>) {
        ...
        val tagCounts = db.journalEntryHasTagDao.getMostUsedTagsList(timeSpan.first,
            timeSpan.second, 10)
