...
import com.bitflaker.lucidsourcekit.main.notification.visual.DelayedTaskHandler
...
class VisualNotificationActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        discardHandler = DelayedTaskHandler(
            { runOnUiThread { finish() } },
            15000
        )   // TODO: Make this value adjustable / allow to disable the auto-close functionality
