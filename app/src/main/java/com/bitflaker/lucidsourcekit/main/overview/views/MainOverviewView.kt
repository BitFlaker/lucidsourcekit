package com.bitflaker.lucidsourcekit.main.overview.views
...
import com.bitflaker.lucidsourcekit.main.alarms.views.AlarmManagerView
import com.bitflaker.lucidsourcekit.main.alarms.views.RecyclerViewAdapterAlarms
...
class MainOverviewView : Fragment() {
    ...
    private val alarmInteractionLauncher = registerForActivityResult(ActivityResultContracts.StartActivityForResult()) { result ->
    ...
    private val alarmManagerLauncher = registerForActivityResult(ActivityResultContracts.StartActivityForResult()) {
        lifecycleScope.launch(Dispatchers.IO) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnManageAlarms.setOnClickListener { alarmManagerLauncher.launch(
            Intent(
                context,
                AlarmManagerView::class.java
            )
        ) }

        // Questionnaire quick access
        binding.btnQaQuestionnaire.setOnClickListener { startActivity(
            Intent(
                context,
                QuestionnaireOverviewActivity::class.java
            )
        ) }
        binding.llQaQuestionnaire.setOnClickListener { binding.btnQaQuestionnaire.performClick() }

        // Notification quick access
        binding.btnQaNotifications.setOnClickListener { startActivity(
            Intent(
                context,
                NotificationManagerView::class.java
            )
        ) }
